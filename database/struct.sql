CREATE TABLE MEMBERS (
    ...
    playTimeTick INTEGER,
    timeSinceLastDeathTick INTEGER,
    numberDeath INTEGER,
    numberJump INTEGER,
    totalMobKill INTEGER,
    totalPlayerKill INTEGER,
    totalParcourDistance NUMERIC(10,3),
    totalParcourDistanceTransportation NUMERIC(10,3),
    totalAdvancement INTEGER,
    damageTaken REAL,
    damageDealt REAL,
    damageBlockedByShield REAL,
    raidWon INTEGER,
    tradedWithVillager INTEGER,
    animalBred INTEGER,
    fishCaught INTEGER,
    totalMineStat INTEGER,
    totalCraftStat INTEGER,
    totalUseStat INTEGER,
    totalKillEntity INTEGER,
    totalEntityKilledBy INTEGER,
    totalScore INTEGER,
    lastUpdate DATE,
